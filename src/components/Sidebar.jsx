  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <SidebarItem icon="/sidebar2.svg" label="Аналитика" isVisible={isHovered} />
        <SidebarItem icon="/sidebar3.svg" label="Магазин" isVisible={isHovered} />
        <SidebarItem icon="/sidebar4.svg" label="Партнеры" isVisible={isHovered} />
        <SidebarItem icon="/sidebar5.svg" label="Отчеты" isVisible={isHovered} />
