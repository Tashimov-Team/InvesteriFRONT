...
const Hero2 = () => {
  ...
  return (
    <section className="relative w-full min-h-[100vh] flex items-center px-6 lg:px-20 bg-[#070816] overflow-hidden">
      <motion.div
        animate={{
          x: (mousePos.x - window.innerWidth / 2) * 0.005,
          y: (mousePos.y - window.innerHeight / 2) * 0.005,
        }}
      ...
      <div className="flex flex-col-reverse lg:flex-row w-full items-center relative z-10">
        ...
        >
          <h1 className="font-inter text-white text-4xl lg:text-5xl font-bold leading-tight max-w-lg">
            Средства на исполнение государственных тендеров и банковских
            гарантий
          </h1>
          <div className="mt-4 bg-[#424B60] px-4 py-3 rounded-xl text-white max-w-xs text-base lg:text-lg">
            Подберем максимально выгодные условия займа для вашего тендера
          </div>
          <Link to="/register"
            className="mt-6 px-6 py-3 bg-pink-600 text-white text-lg font-medium rounded-lg hover:bg-pink-700 transition relative shadow-[0px_0px_10px_4px_rgba(210,7,100,0.6)]"
          >
            Подать заявку
          </Link>
        </motion.div>
